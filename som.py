...
() => {
    ...
    for (const sel of selectors) {
        ...
        for (const el of els) {
            ...
            let kind;
            if (tag === 'button' || type === 'button' || type === 'submit') kind = 'button';
            else if (tag === 'a') kind = 'link';
            else if (type === 'checkbox') kind = 'checkbox';
            else if (type === 'text' || type === 'search' || tag === 'input') kind = 'input';
